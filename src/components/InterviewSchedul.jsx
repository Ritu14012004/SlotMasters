              ...
              {editingIndex === index ? (
                <div className="w-full flex flex-col gap-2">
                  ...
                  <div className="flex justify-end space-x-2">
                    <button 
                      onClick={saveEdit} 
                      className="bg-green-500 text-[#008000] px-5 py-3 rounded-lg font-semibold transition duration-300 hover:bg-green-600"
                    >
                      Save
                    </button>
                    <button 
                      onClick={() => setEditingIndex(null)} 
                      className="bg-gray-500 text-white px-5 py-3 rounded-lg font-semibold transition duration-300 hover:bg-gray-600"
                    >
                      Cancel
                    </button>
                  </div>
                ...
                <div className="w-full flex justify-between items-center">
                  ...
                  <div className="space-x-2">
                    <button 
                      ...
                      className="bg-orange-500 text-[#FFA500] px-5 py-3 rounded-lg font-semibold transition duration-300 hover:bg-orange-600"
                    >
                      Edit
                    </button>
                    <button 
                      onClick={() => deleteInterviewer(index)} 
                      className="bg-red-500 text-[#FF0000] px-5 py-3 rounded-lg font-semibold transition duration-300 hover:bg-red-600"
                    >
                      Delete
                    </button>
                  </div>
